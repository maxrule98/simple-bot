...
See the full implementation roadmap in [ROADMAP.md](ROADMAP.md).
...
The detailed design, examples and configuration have been moved to [ROADMAP.md](ROADMAP.md) and `docs/TRADER_ARCHITECTURE.md` to keep this README concise. See those files for the full strategy, signal, ML, VWAP and monitoring details.
